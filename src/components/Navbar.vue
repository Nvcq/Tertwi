  ...
  <div class="md:flex md:items-center md:justify-between p-5 bg-black">
    ...
    <!-- <div v-else class="mt-4 flex md:mt-0 md:ml-4">
      ...
      <button
        @click="goTo('signIn')"
        type="button"
        class="m-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500"
      >
        Sign In
      </button>
    </div> -->
