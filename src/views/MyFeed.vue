...
<div class="w-100">
  ...
  <body class="h-screen overflow-hidden flex items-center justify-center" style="background: #15202b;">
    ...
    <div class="overflow-y-auto absolute h-screen pr-3" style="width: 275px;">
        ...
        <nav class="mt-5 px-2">
          <div @click="goTo('feed')">
            <a class="cursor-pointer group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300">
          ...
          <div @click="goTo('myfeed')">
              <a class="cursor-pointer mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-gray-800 text-blue-300">
