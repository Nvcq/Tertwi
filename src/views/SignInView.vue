    ...
    <div class="flex w-screen h-screen items-center justify-center">
        <div class="min-h-1/2 border border-gray-900 rounded-2xl border-2 border-white">
            ...
            <div class="mx-4 sm:mx-24 md:mx-34 lg:mx-56 mx-auto  flex items-center space-y-4 py-16 font-semibold text-gray-500 flex-col">
                ...
                <h1 class="text-white text-2xl">Log In to Tertwi</h1>
                ...
                <button @click="signUser()" type="submit" class="w-full p-2 bg-gray-50 rounded-full font-bold text-gray-900 border border-gray-700 ">Log in</button>

                <p>Not a member ?
                    <button @click="goTo('signUp')" type="button" class="font-semibold text-sky-700">Sign up</button>
                </p>
