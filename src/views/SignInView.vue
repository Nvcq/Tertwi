        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              <div class="text-sm">
                <button @click="goTo('signUp')" type="button" class="font-medium text-indigo-600 hover:text-indigo-500">Not a member ? Sign up here</button>
              </div>
            </div>

            <div>
              <button @click="signUser()" type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Log in</button>
            </div>
